...
/**
 * 替代WhitelabelApprovalEndpoint 单点登录中避免出现授权页面
 */
@RestController
...
public class SsoApprovalEndpoint {
    ...
    protected String createTemplate(Map<String, Object> model, HttpServletRequest request) {
        ...
        //在此处进行覆盖 这个页面会是一个白页面 然后就回到原网站
        builder.append("<html><body><div style='display:none;'></div><h1>OAuth Approval</h1>");
        ...
        builder.append("</body></div><script>document.getElementById('confirmationForm').submit()</script></html>");
